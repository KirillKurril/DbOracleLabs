...
BEGIN
    IF INSERTING THEN
        INSERT INTO audit_tracks (
            ...
            new_duration_seconds, new_track_number
        ) VALUES (
            audit_seq.NEXTVAL, 'INSERT', :NEW.track_id,
            :NEW.album_id, :NEW.track_name, 
            :NEW.duration_seconds, :NEW.track_number
        );
    ELSIF UPDATING THEN
        INSERT INTO audit_tracks (
            audit_id, operation_type, track_id,
            ...
            old_track_number, new_track_number
        ) VALUES (
    ...
    ELSIF DELETING THEN
        INSERT INTO audit_tracks (
            ...
            old_duration_seconds, old_track_number
        ) VALUES (
            audit_seq.NEXTVAL, 'DELETE', :OLD.track_id,
            :OLD.album_id, :OLD.track_name, 
            :OLD.duration_seconds, :OLD.track_number
        );
    END IF;
END;
/